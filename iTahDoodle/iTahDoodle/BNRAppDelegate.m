...
//Helper function to fetch the part to our to-do data stored on disk
NSString *docPath(){
...
{
    // Attempt to load an exisiting to-do dataset from an array stored to disk
    ...
    */
    ...
    // Define the frame recetangles of the three UI elements
    // CGRectMake() creates a CGRect from (x, y, width, height)
    CGRect tableFrame = CGRectMake(0, 80, 320, 380);
    CGRect fieldFrame = CGRectMake(20, 40, 200, 31);
    CGRect buttonFrame = CGRectMake(228, 40, 72, 32);
    ...
    [taskField setPlaceholder:@"Type a task here then tap Insert"];
